...
import ca.ualberta.cmput681.assignment1.CoarserGrainedThreadPoolMatrixMultiplication;

public class CoarserGrainedThreadPoolMatrixMultiplicationTest {
	...
	public void testMultiplication() {
		...
		CoarserGrainedThreadPoolMatrixMultiplication.main(args);
		int[][] matrixC = CoarserGrainedThreadPoolMatrixMultiplication
				.getResult();
	...
	public void testMultiplicationAxI() {
		...
		int[][] matrixC = CoarserGrainedThreadPoolMatrixMultiplication
				.getResult();
		int[][] matrixA = CoarserGrainedThreadPoolMatrixMultiplication
				.getMatrixA();
	...
	public void testMultiplicationIxB() {
		...
		int[][] matrixC = CoarserGrainedThreadPoolMatrixMultiplication
				.getResult();
		int[][] matrixB = CoarserGrainedThreadPoolMatrixMultiplication
				.getMatrixB();
