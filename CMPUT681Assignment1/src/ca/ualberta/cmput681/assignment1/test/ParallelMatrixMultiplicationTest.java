...
import ca.ualberta.cmput681.assignment1.ParallelMatrixMultiplication;

public class ParallelMatrixMultiplicationTest {
	...
	public void testMultiplication() {
		...
		ParallelMatrixMultiplication.main(args);
		int[][] matrixC = ParallelMatrixMultiplication.getResult();
	...
	public void testMultiplicationAxI() {
		...
		ParallelMatrixMultiplication.main(args);
		int[][] matrixC = ParallelMatrixMultiplication.getResult();
		int[][] matrixA = ParallelMatrixMultiplication.getMatrixA();
	...
	public void testMultiplicationIxB() {
		...
		ParallelMatrixMultiplication.main(args);
		int[][] matrixC = ParallelMatrixMultiplication.getResult();
		int[][] matrixB = ParallelMatrixMultiplication.getMatrixB();
