...
import ca.ualberta.cmput681.assignment1.SequentialMatrixMultiplication;

public class SequentialMatrixMultiplicationTest {
	...
	public void testMultiplication() {
		...
		SequentialMatrixMultiplication.main(args);
		int[][] matrixC = SequentialMatrixMultiplication.getResult();
	...
	public void testMultiplicationAxI() {
		...
		SequentialMatrixMultiplication.main(args);
		int[][] matrixC = SequentialMatrixMultiplication.getResult();
		int[][] matrixA = SequentialMatrixMultiplication.getMatrixA();
	...
	public void testMultiplicationIxB() {
		...
		SequentialMatrixMultiplication.main(args);
		int[][] matrixC = SequentialMatrixMultiplication.getResult();
		int[][] matrixB = SequentialMatrixMultiplication.getMatrixB();
