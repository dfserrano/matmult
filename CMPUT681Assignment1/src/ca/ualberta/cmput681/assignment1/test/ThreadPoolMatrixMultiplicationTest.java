...
import ca.ualberta.cmput681.assignment1.ThreadPoolMatrixMultiplication;

public class ThreadPoolMatrixMultiplicationTest {
	...
	public void testMultiplication() {
		...
		ThreadPoolMatrixMultiplication.main(args);
		int[][] matrixC = ThreadPoolMatrixMultiplication.getResult();
	...
	public void testMultiplicationAxI() {
		...
		ThreadPoolMatrixMultiplication.main(args);
		int[][] matrixC = ThreadPoolMatrixMultiplication.getResult();
		int[][] matrixA = ThreadPoolMatrixMultiplication.getMatrixA();
	...
	public void testMultiplicationIxB() {
		...
		ThreadPoolMatrixMultiplication.main(args);
		int[][] matrixC = ThreadPoolMatrixMultiplication.getResult();
		int[][] matrixB = ThreadPoolMatrixMultiplication.getMatrixB();
